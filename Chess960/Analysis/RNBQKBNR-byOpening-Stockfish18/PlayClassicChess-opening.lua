...
if #arg >= 1 then
  ...
  if opening == "--help" or opening == "-help" or opening == "help" then
    print("Usage: Play12plyUCIClassicChess.lua {opening} {plies} {seed}")
    print("Example: Play12plyUCIClassicChess.lua 'e2e4 e7e5 f2f4' 18")
    os.exit(0)
  end
end
if #arg >= 2 then
...
if opening:len() > 0 then
  w:write("position startpos moves " .. opening .. "\n")
else
