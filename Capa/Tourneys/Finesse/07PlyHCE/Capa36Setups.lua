...
function isCapa36(setup)
  if type(setup) == 'table' then setup = board2ASCII(setup):upper() end
...
for setup=0,719 do
  ...
  if allPawnsGuarded(board,capaPieces()) and isCapa36(board) then
    print(board2ASCII(board):upper(),board2PGN(board),
