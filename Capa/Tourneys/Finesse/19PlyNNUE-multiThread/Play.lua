...
if #arg < 1 or action:match("^[Hh%?]") or action:match("^%-%-[Hh?]") then 
  ...
  print('action" is "--help", "--play", "--threadXXX", or "--eval"')
  print('If action is "--threadXXX", it allows playing multiple games in')
  print('a multhread compatible form; replace XXX with a unique three')
  print('digit alphanumeric code (e.g. 007 or Ov7)')
